import { ArrowUpward, CalendarMonthOutlined, Close, LocationOnOutlined, PersonOutlined, Search, SportsSoccerOutlined, WhatsApp } from '@mui/icons-material'
  ...
  return <Box sx={{ bgcolor: 'primary.dark', color: 'common.white', minHeight: { xs: 'auto', lg: 650 }, position: 'relative' }}>
    ...
    <Container maxWidth="lg" sx={{ position: 'relative', py: { xs: 6, md: 9 } }}>
      <Grid container spacing={5} sx={{ alignItems: 'center' }}>
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} sx={{ mt: 4 }}><Button color="secondary" component="a" href="#buscar" size="large" startIcon={<Search />} variant="contained">Buscar cancha</Button><IconButton aria-label="Acceso para clubes" component={Link} size="large" sx={{ border: 1, borderColor: 'rgba(255,255,255,.34)', color: 'common.white', borderRadius: 1.5 }} title="Acceso para clubes" to="/acceso"><PersonOutlined /></IconButton></Stack>
        </Grid>
